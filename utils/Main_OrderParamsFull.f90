...
do nspin = 1, numS
    ...
    write(filename,'(A7,A21,I0,A6,I0,A210)') dir,'InterSubInterVal-numb',ndim,'-nspin',nspin,parametersIn
    ...
    write(filename,'(A7,A21,I0,A6,I0,A210)') dir,'IntraSubInterVal-numb',ndim,'-nspin',nspin,parametersIn
    open(98,file=filename,status='replace')
    do i = 1, ndim
    ...
    write(filename,'(A7,A21,I0,A6,I0,A210)') dir,'InterSubIntraVal-numb',ndim,'-nspin',nspin,parametersIn
    open(98,file=filename,status='replace')
    do i = 1, ndim/2
    ...
    write(filename,'(A7,A21,I0,A6,I0,A210)') dir,'IntraSubIntraVal-numb',ndim,'-nspin',nspin,parametersIn
    open(98,file=filename,status='replace')
    do i = 1, ndim
